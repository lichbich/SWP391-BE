...
//                    .itemInStock(20)
//                    .itemInShelf(3)
//                    .categorySet(new HashSet<>(List.of(footwear, male, female)))
...
//                    .itemInStock(30)
//                    .itemInShelf(12)
//                    .categorySet(new HashSet<>(List.of(male, female)))
//                    .createdAt(LocalDateTime.now())
//                    .updatedAt(LocalDateTime.now())
//                    .imagePath("book.com")
//                    .status(true)
...
//                    .itemInStock(13)
//                    .itemInShelf(3)
//                    .categorySet(new HashSet<>(List.of(male, female, underpant, dress)))
//                    .createdAt(LocalDateTime.now())
//                    .updatedAt(LocalDateTime.now())
//                    .imagePath("cloak.com")
//                    .status(true)
...
//
//
////            shoe.setCategorySet(Set.of(footwear, male, female));
////            book.setCategorySet(Set.of(male, female));
////            invisible_cloak.setCategorySet(Set.of(male, female, underpant, dress));
//
...
//                    .build();
//
//            //NOTES: by adding cart to the cartItem, now the cart 3 have cartItem 6
...
//                    .build();
//
//            CartItem item7 = CartItem.builder()
//                    .product(invisible_cloak)
//                    .quantity(1)
//                    .build();
//            cart4.setItems(Set.of(item7));
//            // this will generate a cartItem 7 but with its field cart null
//
//
//            //if list of cartItems are not added to the cart, the cartItem will not be rendered by the code
////            cart1.setItems(Set.of(item1,item2,item3));
////            cart2.setItems(Set.of(item4,item5));
////            //without adding cart to the cartItem, now cart 3 has cartItem 6, cart 4 will be empty
//////            cart4.setItems(Set.of(item6));
////            //correct instance
////            cart3.setItems(Set.of(item6));
//
//            //however, if cartItems are not add to the cart, cartItem table will not be generated also
//
...
//
////            cartRepository.saveAll(List.of(cart1,cart2,cart3,cart4));
//            cartItemRepository.saveAll(List.of(item1,item2,item3,item4,item5,item6,item7));
//
//
//        };
//    }
